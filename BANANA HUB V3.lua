...
function AutoHaki()
    ...
    if char and remote then
        ...
        if not char:FindFirstChild("KenHaki") then
            pcall(function() remote:InvokeServer("Ken") end)
        end
    end
end
...
l_LocalPlayer_4.CharacterAdded:Connect(function()
    task.wait(2)
    if _G.AutoFarm then
        _G.AutoFarm = false
        task.wait(0.1)
...
local v466 = vu32:MakeWindow({
    ...
    SubTitle = "by Yago e Purple Guy",
    SaveFolder = "Banana | Hub"
})

v466:AddMinimizeButton({
    Button = { Image = "https://www.roblox.com/asset-thumbnail/image?assetId=89314897729630&width=420&height=420&format=png", BackgroundTransparency = 0 },
                ...
                while true do
                    ...
                    if v22 ~= _Character and (_HumanoidRootPart and (_Humanoid and (_Humanoid.Health > 0 and (_HumanoidRootPart.Position - v13.Position).Magnitude <= 300))) then
                        ...
                        while true do
                            ...
                            if v28:IsA('BasePart') and (_HumanoidRootPart.Position - v13.Position).Magnitude <= 150 then
                                u17[#u17 + 1] = {v22, v28}
                            end
                        end
                    end
                ...
                if _G.BringMonster and (StartBring and v1167.Name == MonFarm or v1167.Name == Mon and v1167:FindFirstChild("Humanoid") and v1167:FindFirstChild("HumanoidRootPart") and v1167.Humanoid.Health > 0 and (v1167.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 600) then
                    if v1167.Name == "Factory Staff" then
                        if (v1167.HumanoidRootPart.Position - PosMon.Position).Magnitude <= 350 then
                            ...
                            v1167.HumanoidRootPart.Size = Vector3.new(150, 150, 150)                            v1167.HumanoidRootPart.CFrame = PosMon
